@sys_files_0 = Sys::File.new(id: 0)
@sys_files_75 ||= Sys::File.create!(
  name: "illust01.jpg",
  title: "住民基本台帳カード写真なし",
  ...
  image_width: 250,
  image_height: 170,
  file_attachable_id: @gp_article_docs_328.id,
...
@sys_files_77 ||= Sys::File.create!(
  ...
  image_width: 576,
  image_height: 432,
  file_attachable_id: @gp_article_docs_331.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_81 ||= Sys::File.create!(
  ...
  image_width: 576,
  image_height: 432,
  file_attachable_id: @gp_article_docs_332.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_82 ||= Sys::File.create!(
  ...
  image_width: 340,
  image_height: 450,
  file_attachable_id: @gp_article_docs_343.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_83 ||= Sys::File.create!(
  name: "shisan.gif",
  title: "固定資産税の評価における審査申出制度等のフローチャート",
  mime_type: "image/gif",
  size: 20226,
  image_is: 1,
  image_width: 766,
  image_height: 795,
  file_attachable_id: @gp_article_docs_386.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_84 ||= Sys::File.create!(
  ...
  title: "3e2fc63090c933399121a06a36a631d1_s",
  mime_type: "image/jpeg",
  size: 45333,
  image_is: 1,
  image_width: 240,
  image_height: 180,
  file_attachable_id: @gp_article_docs_402.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_85 ||= Sys::File.create!(
  ...
  title: "6c49e2c3fde17c955927ae3198f2d6b5_s",
  mime_type: "image/jpeg",
  size: 48656,
  image_is: 1,
  image_width: 240,
...
@sys_files_86 ||= Sys::File.create!(
  ...
  title: "16552738c0528f0ec196042623c1b0be_s",
  mime_type: "image/jpeg",
  size: 38808,
  image_is: 1,
  image_width: 240,
...
@sys_files_88 ||= Sys::File.create!(
  ...
  title: "3018a9d2ccbe61672bb8d95aec5b58ef_l",
  mime_type: "image/jpeg",
  size: 80760,
  image_is: 1,
  image_width: 240,
  image_height: 180,
  file_attachable_id: @gp_article_docs_453.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
...
@sys_files_110 ||= Sys::File.create!(
  ...
  size: 505906,
  image_is: 2,
  file_attachable_id: @gp_article_docs_571.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  alt_text: ""
)
...
@sys_files_113 ||= Sys::File.create!(
  ...
  image_width: 615,
  image_height: 326,
  file_attachable_id: @gp_article_docs_572.id,
  file_attachable_type: "GpArticle::Doc",
  site_id: @cms_sites_1.id,
  thumb_width: 120,
  thumb_height: 90,
